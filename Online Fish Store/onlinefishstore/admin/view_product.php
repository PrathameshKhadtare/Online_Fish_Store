    ...
    <div class="dashboard-main-wrapper">
       ...
       <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="#">ONLINE FISH STORE</a>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            ...
                                            $select = "SELECT fish_shop_product.*, fish_shop_category.category_name FROM fish_shop_product JOIN fish_shop_category ON fish_shop_product.product_category = fish_shop_category.category_id";
