    ...
    <div class="dashboard-main-wrapper">
        ...
        <!-- ============================================================== -->
         <div class="dashboard-header">
            ...
            <a class="navbar-brand animate__animated animate__heartBeat animate__infinite" href="index.php">
            <span class="gradient-text">ONLINE FISH STORE</span>
            </a>
            


                <!-- <a class="navbar-brand" href="index.php">ONLINE FISH STORE</a> -->
                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            $select = "SELECT * FROM fish_shop_category";
            ...
            <div class="container-fluid dashboard-content">    
                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner rounded">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="uploads/background.jpg" alt="First slide">
                                    <div class="carousel-caption d-md-block pb-5">
                                        <!-- <h3 class="text-white">GOOD FOOD, GOOD LIFE</h3> -->
                                        <!-- <p>fishes are special, every celebration ends with something sweet like a fish and people remember it's all about the memories.</p> -->
                                        <!-- <a href="about.php" class="btn btn-rounded btn-outline-light">Read More</a> -->
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="uploads/background2.jpg" alt="Second slide">
                                    <div class="carousel-caption d-md-block pb-5">
                                        <!-- <h3 class="text-white">The fish we bake with love</h3> -->
                                        <!-- <p>Take the shredded pieces of your life and bake a master fish out of it.</p> -->
                                        <!-- <a href="about.php" class="btn btn-rounded btn-outline-light">Read More</a> -->
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="uploads/background3.jpg" alt="Third slide">
                                    <div class="carousel-caption d-md-block pb-5">
                                        <!-- <h3 class="text-white">Love at first bite</h3> -->
                                        <!-- <p>You can’t be down when you are holding a cupfish.</p> -->
                                        <!-- <a href="about.php" class="btn btn-rounded btn-outline-light">Read More</a> -->
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="uploads/background4.jpg" alt="Fourth slide">
                                    <div class="carousel-caption d-md-block pb-5">
                                        <!-- <h3 class="text-white">A party without fish is really just a meeting.</h3> -->
                                        <!-- <p>fishs are special, every celebration ends with something sweet like a fish and people remember it's all about the memories.</p> -->
                                        <!-- <a href="about.php" class="btn btn-rounded btn-outline-light">Read More</a> -->
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="uploads/background5.jpg" alt="Fifth slide">
                                    <div class="carousel-caption d-md-block pb-5">
                                        <!-- <h3 class="text-white">Eat a fish.</h3> -->
                                        <!-- <p>fishs are special, every celebration ends with something sweet like a fish and people remember it's all about the memories.</p> -->
                                        <!-- <a href="about.php" class="btn btn-rounded btn-outline-light">Read More</a> -->
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="uploads/background6.jpg" alt="Sixth slide">
                                    <div class="carousel-caption d-md-block pb-5">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                        <div class="card text-center p-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Our very first priority is the quality we never compromised in the quality of our fish products.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                        <div class="card text-center p-3">
                            <div class="card-body">
                                <h1 class="card-title"><i class="fa fa-tablet"></i></h1>
                ...
                <div class="row m-5 hero-image2 rounded">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 p-3 hero-text">
                        ...
                        <p class="text-dark px-5">We are Sellers, we make the piece of joy. We believe fish and goods are an expression of love.</p>
                        <p class="text-dark px-5">“Fishing in the right pond is better than fishing in the wrong river.” “It would take a fish a lifetime to climb a tree but only a year to cross the ocean.”</p>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            Copyright © 2024 Concept. All rights reserved. Dashboard by <a href="https://PSK.com/wp/">PSK</a>.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
